...
export const SignUp: React.FC<Props> = observer(() => {
    ...
    const validationSchema = Yup.object({
        emailAddress: Yup.string().email().required('The email address is required'),
            ...
            <Formik
                ...
                {({values, handleChange, handleSubmit}) => (
                    <Form onSubmit={handleSubmit} autoComplete='off'>
                        <InputText placeholder={settingStore.language.emailAddress}
                                   name='emailAddress' label={settingStore.language.emailAddress}/>
                        <InputText placeholder={settingStore.language.Username} 
                                   name='username' label={settingStore.language.Username}/>
